...
contract Verifier is Constants {
    ...
    /*
     * Verifies a single-point evaluation of a polynominal using the Shplonk
     * commitment scheme.
     ...
     * @param _commitment The Shplonk polynominal commitment.
    ...
    function verify(
        ...
        require(_commitment.X < BABYJUB_P, "Verifier.verifyShplonk: _commitment.X is out of range");
        require(_commitment.Y < BABYJUB_P, "Verifier.verifyShplonk: _commitment.Y is out of range");
        require(_proof.X < BABYJUB_P, "Verifier.verifyShplonk: _proof.X is out of range");
        require(_proof.Y < BABYJUB_P, "Verifier.verifyShplonk: _proof.Y is out of range");
        require(_index < BABYJUB_P, "Verifier.verifyShplonk: _index is out of range");
        require(_value < BABYJUB_P, "Verifier.verifyshplonk: _value is out of range");
    ...
    /*
     * @return A shplonk commitment to a polynominal
    ...
    function verifyMulti(
        ...
        require(_commitment.X < BABYJUB_P, "Verifier.verifyMultiShplonk: _commitment.X is out of range");
        require(_commitment.Y < BABYJUB_P, "Verifier.verifyMultiShplonk: _commitment.Y is out of range");
        require(_proof.X[0] < BABYJUB_P, "Verifier.verifyShplonk: _proof.X[0] is out of range");
        require(_proof.X[1] < BABYJUB_P, "Verifier.verifyShplonk: _proof.X[1] is out of range");
        require(_proof.Y[0] < BABYJUB_P, "Verifier.verifyShplonk: _proof.Y[0] is out of range");
        require(_proof.Y[1] < BABYJUB_P, "Verifier.verifyShplonk: _proof.Y[1] is out of range");

        for (uint256 i = 0; i < _iCoeffs.length; i ++) {
            require(_iCoeffs[i] < BABYJUB_P, "Verifier.verifyShplonk: an _iCoeffs value is out of range");
        }

        for (uint256 i = 0; i < _zCoeffs.length; i ++) {
            require(_zCoeffs[i] < BABYJUB_P, "Verifier.verifyShplonk: an _zCoeffs value is out of range");
        }
        ...
        for (uint256 i = 0; i < _indices.length; i ++) {
            ...
            require(index < BABYJUB_P, "Verifier.verifyShplonk: an index is out of range");
            require(value < BABYJUB_P, "Verifier.verifyShplonk: a value is out of range");
        ...
        // Generate the Shplonk commitments to the i and z polynominals
